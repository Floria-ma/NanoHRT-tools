...
class MuonScaleResCorrector(object):
    def __init__(self, year, corr='nominal', geofit=False):
        ...
        if year>2018:
            self.corr=None
            print("\n\n\n\n\nWARNING: ROCHESTER CORRECTIONS DISABLED FOR 2024 --> TO BE FIXED???\n\n\n\n\n")
            # rochester corrections for 2022 and 2023 implemented within correctionlib
            # see https://gitlab.cern.ch/cms-muonPOG/muonscarekit/-/tree/master/corrections?ref_type=heads 
        ...
        if self.corr:
            ...
            fn = os.environ['CMSSW_BASE'] + '/src/PhysicsTools/NanoTrees/data/roccor.Run2.v5/RoccoR%s.txt' % self.era
